...
public class nvCongXuong extends nhanVien{
    private int soGio;
    private int soGioTangCa;
    private double luongTangCa;
    private double luongGio;
    public nvCongXuong(){}
    public nvCongXuong(String maSo,String name,String gioiTinh,String ngaySinh,double luongThuong,double luongPhuCap,double luongGio,
